...
class TestSequenceProtocol(unittest.TestCase):
	...
	def test_before_the_beginning(self):
		with self.assertRaises(IndexError):
			self.s[-6]
	...
	def test_concatenate_intersecting(self):
		s = SortedSet([1, 2, 4])
		t = SortedSet([1, 3, 7])
		self.assertEqual(s+t, SortedSet(1, 2, 3, 4, 7))
	...
	def test_repetition_nonzero_right(self):
		s = SortedSet([1, 2, 3])
		self.assertEqual(100*s, SortedSet())	
	...
	def test_repetition_nonzero_left(self):
		s = SortedSet([1, 2, 3])
		self.assertEqual(s*100, SortedSet())
...
class TestInequalityProtocol(unittest.TestCase):
	...
	def test_positive_unequal(self):
		self.assertTrue(SortedSet([4, 5, 6]) != SortedSet([6, 6, 4]))
